...
Prometheus is required for metric collection and autoscaling evaluation, while Grafana is mainly used for dashboard-based observation.

Grafana is optional, but useful for **visualising traffic, packet rate, and scaling behaviour in real time** during experiments.
